...
use embassy_tmc::tmc2209::TMC2209;
...
pub struct BuddySteppers<'a> {
    pub x: BuddyStepperExti<'a>,
    pub y: BuddyStepperExti<'a>,
    pub z: BuddyStepperExti<'a>,
    pub e: BuddyStepperInp<'a>,
}
