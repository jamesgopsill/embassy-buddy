...
use fan::Fan;
use filament_sensor::FilamentSensor;
use heater::Heater;
use packed_struct::PackedStructSlice;
use pinda::Pinda;
use rotary_button::RotaryButton;
use rotary_encoder::RotaryEncoder;
use thermistor::Thermistor;
use tmc2209::{registers::TMC2209Register, TMC2209Error, TMC2209};
...
impl Board {
    ...
    async fn init_uart(uart: USART2, tx: PD5) {
    ...
    async fn init_filament_sensor(pin: AnyPin, exti: AnyChannel) {
    ...
    async fn init_heaters(tim: TIM3, bed_pin: PB0, hotend_pin: PB1) {
    ...
    async fn init_rotary_button(pin: AnyPin, exti: AnyChannel) {
    ...
    async fn init_pinda(pin: AnyPin, exti: AnyChannel) {
