...
impl<'a> Board<'a> {
    ...
    pub async fn init_x_stepper(
        ...
        TMC2209AsyncUart::new_with_interrupt(en, step, dir, dia, 1, STEPPER_USART.get().await)
            .unwrap()
    }
    ...
    pub async fn init_y_stepper(
        ...
        let dir = Output::new(dir, Level::High, Speed::VeryHigh);
        let dia = ExtiInput::new(dia_pin, dia_ch, Pull::None);
        TMC2209AsyncUart::new_with_interrupt(en, step, dir, dia, 3, STEPPER_USART.get().await)
            .unwrap()
    }
    ...
    pub async fn init_z_stepper(
        ...
        let dir = Output::new(dir, Level::High, Speed::VeryHigh);
        let dia = ExtiInput::new(dia_pin, dia_ch, Pull::None);
        TMC2209AsyncUart::new_with_interrupt(en, step, dir, dia, 0, STEPPER_USART.get().await)
            .unwrap()
    }
    ...
    pub async fn init_e_stepper(
        ...
        TMC2209AsyncUart::new_with_input(en, step, dir, dia, 2, STEPPER_USART.get().await).unwrap()
    }
}
...
impl<'a> Board<'a> {
    pub async fn new(
        ...
        let thermistors = Thermistors { board, bed, hotend };
